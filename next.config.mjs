...
// Next.js App Router configuration with forced classic Webpack compiler for Vercel production deployment
const nextConfig = {
  ...
  env: {
    ...
    VITE_FIREBASE_DATABASE_URL: process.env.VITE_FIREBASE_DATABASE_URL || process.env.NEXT_PUBLIC_FIREBASE_DATABASE_URL,
    ...
    VITE_FIREBASE_MEASUREMENT_ID: process.env.VITE_FIREBASE_MEASUREMENT_ID || process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID,
  ...
  webpack: (config, { webpack }) => {
    ...
    config.plugins.push(
      new webpack.DefinePlugin({
        ...
        'import.meta.env.VITE_FIREBASE_MEASUREMENT_ID': JSON.stringify(process.env.VITE_FIREBASE_MEASUREMENT_ID || process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID),
      })
    );
    return config;
  }
